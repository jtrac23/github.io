            ...
            <div class="col-md-12">
                ...
                <section>
                    ...
                    while($row=mysqli_fetch_assoc($result)){
                        ...
                        echo '<div id="blogPanel" class="panel panel-default center-block">';
...
<!--ADD POST MODAL-->
	...
	<div class="modal fade" id="addVideoModal" role="dialog">
        ...
        <!--This script causes the youtube videos to be responsive https://github.com/toddmotto/fluidvids -->
